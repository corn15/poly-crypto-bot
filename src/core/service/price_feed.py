...
class PriceFeedService:
    def __init__(
        ...
        self.past_4h_5m_candles: Dict[str, List[Candle]] = {}
    ...
    def update(self):
        for asset in self.price_feed_provider.get_assets():
            ...
            self.past_4h_5m_candles[asset] = self.price_feed_provider.get_historical_candles(
                asset, 48
            )
    ...
    def get_past_4h_5m_candles(self, asset: str) -> List[Candle]:
        return self.past_4h_5m_candles[asset]
